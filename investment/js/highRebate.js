$(function(){
	 ...
	 * 新功能部分用户开放
	 */
	if(userID=="929"||userID="1"){
		console.log(userID);
	}else{
		$("body").html("功能暂未开放");
		$("html").css("height","100%");
		$("body").css({"display": "flex", "display": "-webkit-flex", "flex-direction": "column", "justify-content":"center", "align-items": "center","height":"100%"});
		$(".rank").hide();
		return;
	};
	/**
    ...
    $('.content').dropload({   	
        ...
        loadDownFn : function(me){
            ...
            $.ajax({
                type: "GET",
                url: ajaxUrl+"/investment/task/list?pageNo="+page,
                dataType: 'json',
